        ...
        if (this.getDeltaMovement().horizontalDistanceSqr() > 1.0E-6) {
            if (this.isSprinting()) {
                if (this.isBaby()) {
                    ...
                    event.setControllerSpeed((float)(0.92F * Math.max(0.1, this.walkAnimation.speed() * 3.0)));
                }
            } else {
                event.setAnimation(WALK);
                if (this.isBaby()) {
                    event.setControllerSpeed((float)(0.48F * Math.max(0.1, this.walkAnimation.speed() * 3.0)));
                } else {
                    event.setControllerSpeed((float)(0.4F * Math.max(0.1, this.walkAnimation.speed() * 3.0)));
                }
            }
