...
public class LizardTailModel extends GeoModel<LizardTail> {
    ...
    public Identifier getModelResource(GeoRenderState renderState) {
        return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "entity/lizard_tail");
    }
    ...
    public Identifier getAnimationResource(LizardTail lizard) {
        return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "lizard_tail.rp_anim");
    }
}
