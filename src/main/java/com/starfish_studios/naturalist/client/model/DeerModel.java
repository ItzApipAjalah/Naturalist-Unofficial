...
public class DeerModel extends GeoModel<Deer> {
    ...
    public Identifier getModelResource(GeoRenderState renderState) {
        if (Boolean.TRUE.equals(renderState.getOrDefaultGeckolibData(IS_BABY, false))) {
            return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "entity/fawn");
        }
        return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "entity/deer");
    }
    ...
    public Identifier getAnimationResource(Deer deer) {
        return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "deer.rp_anim");
    }
}
