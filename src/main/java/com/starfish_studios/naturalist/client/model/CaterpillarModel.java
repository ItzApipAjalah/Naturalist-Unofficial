...
public class CaterpillarModel extends GeoModel<Caterpillar> {
    ...
    public Identifier getModelResource(GeoRenderState renderState) {
        return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "entity/caterpillar");
    }
    ...
    public @NotNull Identifier getAnimationResource(Caterpillar animatable) {
        return Identifier.fromNamespaceAndPath(Naturalist.MOD_ID, "caterpillar.rp_anim");
    }
}
